...
const files = [
  { in: `${artifactsDir}/lamine_new_raw_1779885777590.png`, out: `${publicDir}/players/lamine-yamal.png` },
  { in: `${artifactsDir}/cr7_premium_raw_1779885824612.png`, out: `${publicDir}/players/cristiano-ronaldo.png` }
];
