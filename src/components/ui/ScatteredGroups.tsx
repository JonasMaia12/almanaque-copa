    ...
    <div className="w-full flex flex-col items-center">
      ...
      <div className="w-full flex justify-center mb-12 relative z-30 px-4">
        ...
        <button
          ...
          className="relative inline-flex items-center gap-3 bg-teal-100 hover:bg-teal-50 p-4 pt-5 px-8 shadow-scrapbook border border-teal-200/30 font-marker text-lg text-teal-950 rotate-[2deg] hover:rotate-[1deg] transition-all duration-200 cursor-pointer uppercase tracking-wider"
